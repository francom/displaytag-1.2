...
public final class TableProperties implements Cloneable
{
    ...
    /**
     * Property <code>pagination.pagesize</code>. Holds the default number of rows for paginated tables.
     * It can be overridden by setting the value of the pagesize attribute of <display:table> tag.
     * Now the attribute is not mandatory, and when not specified it's set to the default one.
     * To disable pagination it's now necessary to specify the pagesize attribute and set it with -1.
     */
    public static final String PROPERTY_STRING_PAGING_PAGE_SIZE = "pagination.pagesize";
    ...
    /**
     * Obtain pagesize value
     * @return
     */
    public int getPaginationPageSize()
    {
        return getIntProperty(PROPERTY_STRING_PAGING_PAGE_SIZE,10);
    }
